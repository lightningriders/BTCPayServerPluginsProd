...
public class ApplicationPartsLogger : IHostedService
{
    ...
    public ApplicationPartsLogger(IStoreRepository storeRepository, ILogger<ApplicationPartsLogger> logger,
              InvoiceRepository invoiceRepository, ApplicationPartManager partManager)
    {
